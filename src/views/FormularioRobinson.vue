<template>
  <div>
    <Header />
     ...
     <h1 class="Título_Principal">Datos Ciudadano</h1>
        
        <div class="Ingresar_Datos">
            <p class="ID_Ciudadano_Ingresar"><b>Digite el ID del ciudadano</b> &nbsp;&nbsp;<input type="text" name="ID"/>
            &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;<b>Fecha</b>&nbsp;&nbsp;<input type="date" name="Birth_date" />
            <br>
            </p>
            <p class="seleccionar_ciudad">
                <b>Ciudad</b>&nbsp;&nbsp;<select name="ciudad">
            ...
            <p class="Nombre-Tipo_ID">
                <b>Nombre</b>&nbsp;&nbsp;<input type="text" name="nombre"/>
                &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;<b>Tipo ID</b>&nbsp;&nbsp;<select name="tipo_id">
                <option value="seleccionar" selected>Seleccionar</option>
                <option value="cc">CC Cédula ciudadanía</option>
                <option value="nuip">NUIP No. Único Identificación Personal</option>
                <option value="rc">RC Registro Civil</option>
                <option value="TI">TI Tarjeta de Identidad</option>
                <option value="CE">CE Cédula de Extranjería</option>
                <option value="pasaporte">Pasaporte</option>
                <option value="ASI">ASI Adulto sin Identificación</option>
                </select>
            </p>
            <p class="Apellidos-EAPB_Responsable">
                <b>Apellidos</b>&nbsp;&nbsp;<input type="text" name="apellidos"/>
                &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;<b>EAPB responsable</b>&nbsp;&nbsp;<select name="EAPB_responsable">
                <option value="seleccionar" selected>Seleccionar</option>
            ...
            <p class="Fecha_nacimiento-Edad">
                <b>Fecha nacimiento</b>&nbsp;&nbsp;<input type="date" name="fecha_nacimiento"/>
                &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;<b>Edad</b>&nbsp;&nbsp;<input type="number" name="edad"/>
            </p>
            <hr/>
            <p class="subtítulo_1">
                <b>Datos del responsable del vacunado, en caso que aplique.</b>
            </p>
            <p class="Nombre-Tipo_ID">
                <b>Nombre</b>&nbsp;&nbsp;<input type="text" name="nombre"/>
                &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;<b>Tipo ID</b>&nbsp;&nbsp;<select name="tipo_id">
            ...
            <p class="Apellidos-EAPB_Responsable">
                <b>Apellidos</b>&nbsp;&nbsp;<input type="text" name="apellidos"/>
                &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;<b>Número ID</b>&nbsp;&nbsp;<input type="text" name="ID">
            </p>
            <hr/>
            <p class="nombre_vacuna-esquema_vacuna">
                <b>Nombre de la vacuna a aplicar</b> &nbsp;&nbsp; <select name="nombre_vacuna">
                    <option value="seleccionar" selected>Seleccionar</option>
                ...
                <br>
                <b>Esquema de esta vacuna</b> &nbsp;&nbsp; <select name="esquema_vacuna">
                    <option value="seleccionar" selected>Seleccionar</option>
                    ...
                    <option value="tercera_dosis">Tercera dosis</option>
                </select>
            </p>
        </div>
        

        <!--<div class="Recomendaciones-Datos_ciudano">
            <p class="botones_izquierda"></p>
                <button class="recomendaciones" onclick="Rec()"><p class="rec_text">Recomendaciones</p>
                    <script>
                    function Rec() {
                ...
                <button class="DC" onclick="DC()"><p class="DC_text">Datos Ciudadano</p>
                    <script>
                    function DC() {
                    var x = document.createElement("BUTTON");           
                    }
...
.columna1 {
    background-color: rgb(92, 100, 218);
    text-align: center;
}
...
.Recomendaciones-Datos_Ciudadano {
    vertical-align: -20px;
    width: 400px;
    height: 500px;
}
